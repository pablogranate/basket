...
//
// Was a raw <a> (full document reload per flip). Not eagerly prefetched: the
// flipped order is a whole second copy of the current window's payload, and
// unlike the date arrows there is no adjacency to bet on. It is warmed on
// hover/focus instead, so a click is not a cold round-trip.
