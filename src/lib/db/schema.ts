...
export const collaboratorReports = pgTable("collaborator_reports", {
	...
	soundCheck: boolean("sound_check").default(false).notNull(),
	internetCheck: boolean("internet_check").default(false).notNull(),
	cameraCheck: boolean("camera_check").default(false).notNull(),
